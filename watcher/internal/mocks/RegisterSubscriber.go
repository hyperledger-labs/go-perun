...
func (_m *RegisterSubscriber) Subscribe(_a0 context.Context, _a1 map[int][32]byte) (channel.AdjudicatorSubscription, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, map[int][32]byte) (channel.AdjudicatorSubscription, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, map[int][32]byte) channel.AdjudicatorSubscription); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, map[int][32]byte) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
