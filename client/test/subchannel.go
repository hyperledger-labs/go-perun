...
func NewSusie(setup RoleSetup, t *testing.T) *Susie {
	return &Susie{Proposer: *NewProposer(setup, t, 7)}
}
...
func NewTim(setup RoleSetup, t *testing.T) *Tim {
	return &Tim{Responder: *NewResponder(setup, t, 7)}
}
